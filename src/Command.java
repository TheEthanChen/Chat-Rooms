...
class NicknameCommand extends Command {
    ...
    public Broadcast updateServerModel(ServerModel model) {
        if (ServerModel.isValidName(this.newNickname)) {
            return model.newNickname(this.getSenderId(), this.newNickname, this);
            }
...
class CreateCommand extends Command {
    ...
    @Override
    public Broadcast updateServerModel(ServerModel model) {
        if (ServerModel.isValidName(this.channel)) {
            return model.createChannel( this.channel, this.getSenderId(), this.getSender(), this);
        }
        return Broadcast.error(this, ServerError.INVALID_NAME);
    }
...
class JoinCommand extends Command {
    ...
    @Override
    public Broadcast updateServerModel(ServerModel model) {
        return model.joinChannel(this.channel, this.getSenderId(), this.getSender(), this);
    }
...
class MessageCommand extends Command {
    ...
    @Override
    public Broadcast updateServerModel(ServerModel model) {
        return model.message(this.channel, this.getSender(), this);
    }
...
class LeaveCommand extends Command {
    ...
    @Override
    public Broadcast updateServerModel(ServerModel model) {
        return model.leave(this.channel, this.getSenderId(), this.getSender(), this);
    }
...
class InviteCommand extends Command {
    ...
    @Override
    public Broadcast updateServerModel(ServerModel model) {
        return model.inviteChannel(this.channel, this.getSender(), this, this.userToInvite);
    }
...
class KickCommand extends Command {
    ...
    @Override
    public Broadcast updateServerModel(ServerModel model) {
        return model.kick(this.channel, this.getSenderId(), this.getSender(), this, 
                          this.userToKick);
    }
